...
<p><a href="/css/default.asp">CSS Tutorial</a></p> `;
    ...
    expect(getURLsFromHTML(html, baseURL)).toContain(
      "https://www.w3.org/css/default.asp",
    );
    expect(getURLsFromHTML(html, baseURL)).not.toContain(
      "https://www.w3.org/html_images.asp",
    );
  });
...
describe("NormalizeURL", () => {
  ...
  test("returns valid multi-level path", () => {
    expect(normalizeURL("http://blog.boot.dev/path/again")).toBe(
      "blog.boot.dev/path/again",
    );
    expect(normalizeURL("http://boot.dev/path/again?q=hello")).toBe(
      "boot.dev/path/again",
    );
    expect(normalizeURL("http://boot.dev/path/again/no/matter/how/long")).toBe(
      "boot.dev/path/again/no/matter/how/long",
    );
  });
